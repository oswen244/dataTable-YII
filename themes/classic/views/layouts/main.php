			...
			<div class="container-fluid">
				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							array('label'=>'Home', 'url'=>array('/invheader/index')),
							array('label'=>'About', 'url'=>array('/invheader/page', 'view'=>'about')),
							array('label'=>'Contact', 'url'=>array('/invheader/contact')),
							array('label'=>'Login', 'url'=>array('/invheader/login'), 'visible'=>Yii::app()->user->isGuest),
							array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/invheader/logout'), 'visible'=>!Yii::app()->user->isGuest)
						),
					)); ?>
